...
#define _NOSCG OSCCONbits.NOSCG
#define _COSCG OSCCONbits.COSCG
#define _NOSCG0 OSCCONbits.NOSCG0
#define _NOSCG1 OSCCONbits.NOSCG1
#define _NOSCG2 OSCCONbits.NOSCG2
#define _COSCG0 OSCCONbits.COSCG0
#define _COSCG1 OSCCONbits.COSCG1
#define _COSCG2 OSCCONbits.COSCG2
...
--     FPWRT_PWR32          32ms
--     FPWRT_PWR64          64ms
--     FPWRT_PWR128         128ms    i1
--
*/

#define PWRTEN_ON            0xFFF7
